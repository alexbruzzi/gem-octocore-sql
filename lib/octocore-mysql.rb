...
require 'octocore-mysql/version'
require 'octocore-mysql/config'


require 'octocore-mysql/models'
require 'octocore-mysql/counter'
require 'octocore-mysql/email'
require 'octocore-mysql/utils'

require 'octocore-mysql/trendable'
require 'octocore-mysql/baseline'
require 'octocore-mysql/trends'
require 'octocore-mysql/kldivergence'
require 'octocore-mysql/segment'

# Mailer and scheduler should always be required in the following order
require 'octocore-mysql/mailer'
require 'octocore-mysql/scheduler'

require 'octocore-mysql/message_parser'

require 'octocore-mysql/schedeuleable'
require 'octocore-mysql/helpers'
require 'octocore-mysql/kafka_bridge'
require 'octocore-mysql/stats'
...
module Octo
  ...
  def self._connect(configuration)
    ...
    ActiveRecord::Base.update_cache_config(*cache_config.values_at(:host, :port))
    ...
    require 'octocore-mysql/callbacks'
